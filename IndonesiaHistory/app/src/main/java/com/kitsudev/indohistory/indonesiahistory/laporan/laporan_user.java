...
public class laporan_user extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Laporan Data User");

        viewAdapter = new RecyclerViewAdapter_User(this,results);
        ...
        call.enqueue(new Callback<Value>() {
            ...
            public void onResponse(Call<Value> call, Response<Value> response) {
                ...
                if (value.equals("1")) {
                    ...
                    viewAdapter = new RecyclerViewAdapter_User(laporan_user.this, results);
                    recyclerView.setAdapter(viewAdapter);
                }
            }
